...
const Annual = () => {
  ...
  return (
    <div>
        ...
        <br/>
        <div>
            <p id="leavepag"><span id="boardleave">Dashboard &gt; Apply for Leave &gt; Annual Leave</span></p>
        </div>
        <div className="leaveform">
           <div className='leavehead' >
            <br/>
            <h2 className='cation'> <FontAwesomeIcon icon={faBookOpen} id="open" />Leave Application</h2>
            <p id="fields">Fill the required fields below to apply for annual leave.</p>
            </div>
             <form onSubmit={handleSubmit} className="leave-form">
            <div className='leaveform1'>
                <label id="leaveform1label">Leave Type</label>
                <input type="text" id="leavetype" value="Annual Leave" />
            </div>
